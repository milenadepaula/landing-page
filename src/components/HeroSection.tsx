        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mx-0 py-[120px] my-0">
          <div className="animate-slide-in-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button size="lg" className="bg-[#A8482C] hover:bg-primary/90 text-primary-foreground mx-[5px]"><a href="https://wa.me/+554188618118?text=Olá,%20visitei%20seu%20site%20e%20gostaria%20de%20agendar%20uma%20sessão%20de%20terapia!%20Obrigado" target="blank">Agendar sessão</a></Button>
